...
void set_time(void) {
    ...
    if(time_print_flag == 0)
    {
        ...
        clcd_putch((hour / 10) + 48, (0xC0 + (4)));
        clcd_putch((hour % 10) + 48, (0xC0 + (5)));
        clcd_putch(':', (0xC0 + (6)));
    ...
    if(field_select == 0)
    {
        ...
        if(delay1 == 100)
        {
            clcd_putch(0xFF, (0xC0 + (4)));
            clcd_putch(0xFF, (0xC0 + (5)));
        }
        else if(delay1 == 200)
        {
            time_print_flag = 0;
    ...
    if(field_select == 1)
    {
        ...
        if(delay2 == 100)
        {
            clcd_putch(0xFF, (0xC0 + (7)));
            clcd_putch(0xFF, (0xC0 + (8)));
        }
        else if(delay2 == 200)
        {
            time_print_flag = 0;
    ...
    if(field_select == 2)
    {
        ...
        if(delay3 == 100)
        {
            clcd_putch(0xFF, (0xC0 + (10)));
            clcd_putch(0xFF, (0xC0 + (11)));
        }
        else if(delay3 == 200)
        {
            time_print_flag = 0;
